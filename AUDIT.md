# Conversion audit — educational-leadership
...
- Inline style attributes converted to classes: 75 occurrences, 21 distinct declarations.
...
- Buttons given an explicit type: 6; tables given a <tbody>: 4; <th> given a scope: 12; raw ampersands encoded: 2; top navigation given an accessible name.
- Sections with ids: 12 (what, org, leadership, improvement, pdsa, data, politics, law, equity, audit, learning, glossary).
